...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark danger-color lighten-1 mb-5">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent-555">
        <ul class="navbar-nav mr-auto">
            ...
            <!-- Utenti -->
            <li class="nav-item <?php echo ($_SESSION['nav_bar_item'] == UTENTI)? 'active': null ?>">
                <a class="nav-link" href="<?php echo URL . 'user' ?>">Utenti
                    <span class="sr-only">(current)</span>
                </a>
            </li>

            <!-- Categorie -->
            <li class="nav-item <?php echo ($_SESSION['nav_bar_item'] == CATEGORIE)? 'active': null ?>">
                <a class="nav-link" href="<?php echo URL . 'category' ?>">Categorie</a>
            </li>
