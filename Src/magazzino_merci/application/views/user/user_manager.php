<div class="container">
    ...
    <hr>
    <p>In questa pagina puoi consultare la lista degli utenti </p>
    <p><a href="<?php echo URL . 'user/showAddUserPage' ?>">Aggiungi</a> un nuovo utente<br>
    <a href="<?php echo URL . 'user/usersRecoveryPage' ?>">Recupera </a> utente</p>
    <hr>
    ...
    <table id="usersTable" class="table text-center border-top table-responsive-sm">
        ...
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td>
                    <a class="text-info" href="<?php echo URL . 'user/updateUserPage/' . $user['id'] ?>">
                ...
                <td>
                    <a class="text-info"
                       ...
                       onclick="deleteUser(<?php echo $user['id'] ?>, '<?php echo rawurlencode($user['nome'] . ' ' . $user['cognome']) ?>')">
